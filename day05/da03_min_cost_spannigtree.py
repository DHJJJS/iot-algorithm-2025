...
G.graph[춘천][서울] = 10; G.graph[춘천][속초] = 15; G.graph[서울][춘천] = 10;
G.graph[서울][속초] = 40; G.graph[서울][광주] = 50; G.graph[속초][춘천] = 15;
G.graph[속초][서울] = 40; G.graph[속초][대전] = 12; G.graph[서울][대전] = 11;
...
while len(newAry) > (SIZE - 1): # 간선의 수가 (정점의 수 - 1) 될때까지 반복
    ...
    if startYN and endYN: # 둘다 다른 간선 잇으니까 지금 간선을 지워도 됨
        del(newAry[index])
